/**
 * A view object for the board. This is a jpanel responsible for drawing and sizing components, it has nothing to do with the simulation behavior. 
 * This object gets to stay the same in refactor! :D
 *
...
public class Board extends JPanel {
	...
	public Board(int pixelSize, int bs, int max) {
		...
		preferredSize = new Dimension(bs * pixelSize, bs*pixelSize);
